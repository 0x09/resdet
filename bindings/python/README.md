...
resdet's detection parameters can be controlled by calling resdetect or the Analysis constructor with `parameters = { "threshold": the_threshold, "range": the_range, "compression_filter": the_compression_filter }`
