...
resdet can be used as a library by including [resdet.h](https://github.com/0x09/resdet/blob/master/include/resdet.h) and linking with libresdet. To install the library, use `make install-lib` after building.  
