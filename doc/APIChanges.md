...
* Addition of the `resdet_open_image_with_reader` function which gives control over which specific image reader will be used to open/read an image. (33c4b1a)
  * The Python bindings' `Image` constructor has been updated with an `image_reader` parameter to reflect this addition. (9b0bef4)
...
* Addition of the `OMIT_Y4M_READER` configuration macro to disable building resdet's built-in Y4M image reader. (4a13159)
